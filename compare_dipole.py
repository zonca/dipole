...
dip = Dipole(obt,K_CMB=True,relativistic=False,coord='G')
dipole = dip.get(ch, det_dir)
diprel = Dipole(obt,K_CMB=True,relativistic=True,coord='G')
...
plt.plot(obt,(dipolerel-dipx[i:i+span])*1e3,'m',label='terel-dpc')
